## Title:       Jiggler Bells
## Description: My a little advanced very basic mouse jiggler :)
...
def info(message):
    ...
    info_window.iconbitmap("C:\\Users\clcostin\OneDrive - NTT DATA EMEAL\\Documents\\scripts\\python\\assets\\mouse-icon.ico")
...
# since the jiggle function is blocking
...
def main():
    ...
    root.iconbitmap("./mouse-icon.ico")
